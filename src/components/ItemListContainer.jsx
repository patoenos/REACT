...
return (
    <>        
     <h3>En este ejemplo de contador, el valor inicial es 5 y el tope es 20</h3>
     <h4>No deja subir de 20 y tampoco deja bajar de 5 a menos que se de clic en reseteo a 1</h4>
      <br /> 
